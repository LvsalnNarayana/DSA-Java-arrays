...
| #   | Problem Description                                 | Category         | filename         |
| --- | --------------------------------------------------- | ---------------- | ---------------- |
...
| 19  | Check if two arrays are equal                       | Array Comparison |
| 20  | Find missing number from 0–n (sum formula)          | Math + Array     |
| 21  | Find missing number using XOR                       | Bit Manipulation |
| 22  | Find frequency of all elements                      | Hashing          |
